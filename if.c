...
int main(void)
{
 ...
 printf("seed of random number generator (time in seconds since 00:00 hours, Jan 1, 1970 UTC):");
printf("%d\n" , seed_of_random_number_generator);

//https:cplusplus.com/reference/cstdlib/strand/
...
if ( random_number % 5 == 0) //NB! operations are executed simulteniously
  {
